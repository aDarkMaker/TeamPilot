...
export default function HomePage() {
	...
	const loadHomeData = async () => {
		const results = await Promise.allSettled([fetchMeRole(), fetchAnnouncements(3), fetchBiliDynamics(), fetchTodayBirthdays()]);
									...
									<div className="home-ann-head">
										...
										{canPublish ? (
											<div className="home-ann-actions">
												...
												<button type="button" className="home-btn home-btn-danger" disabled={busy} onClick={() => void onDeleteAnnouncement(a.id)}>
													移除
												</button>
											</div>
										) : null}
