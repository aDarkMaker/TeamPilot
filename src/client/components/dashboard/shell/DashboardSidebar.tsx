		...
		<>
			<aside ref={sidebarRef} className={`dashboard-sidebar ${sidebarOpen ? 'is-open' : ''}`}>
				...
				<ul className="dashboard-nav">
					...
					<li className={isStaffRole(me?.role) ? undefined : 'dashboard-nav-item--hidden'} aria-hidden={!isStaffRole(me?.role)}>
				...
				<div className="dashboard-user-card">
					{me ? <UserAvatar username={me.username} avatarUrl={me.avatarUrl ?? null} /> : <div className="avatar-letter">…</div>}
					<div className="meta">
