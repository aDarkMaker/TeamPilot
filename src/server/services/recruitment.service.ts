...
const DEPARTMENT_VALUES = ['vup', 'video', 'art', 'live', 'copywriting', 'clip', 'tech'] as const satisfies readonly [
...
const INTERVIEW_SLOT_VALUES = ['none'] as const satisfies readonly [RecruitmentInterviewSlot, ...RecruitmentInterviewSlot[]];
